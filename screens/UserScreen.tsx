    ...
    render() {
        ...
        let form = this.state.switched ? <>
                ...
                <View style={styles.buttonsView}>
                    ...
                    <View style={styles.buttonWrapper}><StyledButton onPress={() => this.setState({switched: false, errors: undefined})} inverted={true}>{i18n.goToSignIn.toUpperCase()}</StyledButton></View>
                </View>
            </> : <>
                <View style={styles.inputsAndValidationResultView}>
                    <View style={styles.inputsView}>
                ...
                <View style={styles.buttonsView}>
                    ...
                    <Text style={styles.orText}>{i18n.or.toUpperCase()}</Text>
                    <View style={styles.buttonWrapper}><StyledButton onPress={() => this.setState({switched: true, errors: undefined})} inverted={true}>{i18n.goToSignUp.toUpperCase()}</StyledButton></View>
                </View>
            </>;
        return (
